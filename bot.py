...
async def help_command(
    ...
    embed.add_field(
        ...
        value=(
            "`/login` — Connect this server "
            "to a ComVerify project."
        ),
        inline=False
    )
...
@bot.tree.command(
    name="verify",
    description="Send the ComVerify verification panel."
)
async def verify(
    interaction: discord.Interaction
):
...
@bot.tree.command(
    name="restore",
    description="Restore a ComVerify backup."
)
async def restore(
    interaction: discord.Interaction
):
    await restore_command(
        interaction
    )
...
@bot.tree.command(
    name="announce",
    description="Send an announcement to verified members."
)
@app_commands.describe(
    message="The announcement you want to send."
)
async def announce(
    interaction: discord.Interaction,
    message: str
